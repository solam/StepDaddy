var fspaAudioWorkletPolySynth = function(synthInstanceString) {
    ...
    //this.init = async function() {    
        ...
        this.context = window['audio_context_origin'];
        ...
        //if (cnter != 1) {
            ...
            this.module = await this.context.audioWorklet.addModule('/sequencer/instruments/fspaAudioWorkletPolySynth/worklet'+nbr+'.js');
